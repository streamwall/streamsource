...
RSpec.describe StreamSerializer do
  ...
  describe "with different statuses" do
    it "serializes offline streams correctly" do
      ...
      serialization = JSON.parse(ActiveModelSerializers::Adapter.create(described_class.new(offline_stream,
                                                                                            scope: scope)).to_json)
  ...
  describe "with unpinned streams" do
    it "serializes unpinned streams correctly" do
      ...
      serialization = JSON.parse(ActiveModelSerializers::Adapter.create(described_class.new(unpinned_stream,
                                                                                            scope: scope)).to_json)
  ...
  describe "edge cases" do
    it "handles very long sources" do
      stream.source = "A" * 255
      serialization = JSON.parse(ActiveModelSerializers::Adapter.create(described_class.new(stream,
                                                                                            scope: scope)).to_json)
