  ...
  describe "POST create" do
    ...
    context "with valid params" do
      it "creates resource" do
        expect {
          post :create, params: { resource_name => valid_params }
        }.to change(resource_name.to_s.camelize.constantize, :count).by(1)
      end
    ...
    context "with invalid params" do
      it "does not create resource" do
        expect {
          post :create, params: { resource_name => invalid_params }
        }.not_to change(resource_name.to_s.camelize.constantize, :count)
      end
